...
get_features('dsgdb9nsd_000001',1,0)
...
res.head()
res.to_csv('../data/neighborhood/1JHC/1JHC_unified_features.csv')

t_res = pd.DataFrame(t_res)
t_res.index = test.index
t_res.columns = FEATURE_COLS
t_res.shape
t_res.to_csv('../data/neighborhood/1JHC/1JHC_unified_features_test_v2.csv')
