...
class Simple_NN(nn.Module):
    def __init__(self, input_dim, hidden_dim, dropout=0.95, activation=nn.ReLU()):
        ...
        self.fc2 = nn.Linear(int(hidden_dim * input_dim), hidden_dim)
        self.fc25 = nn.Linear(int(hidden_dim), int(hidden_dim / 2))
